    ...
    <section class="relative">
        <div class="py-8 px-10 mx-auto max-w-screen-xl lg:py-16 lg:px-6 " id="features">
            <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12 mt-14">
                ...
                <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Here at ChitChatChampion we focus on
                    building solutions that unlock long-lasting memories and meaningful first-impressions.</p>
            </div>
        </div>
        <div class="grid grid-cols-1 lg:grid-cols-3 mb-16 gap-20 max-w-screen-xl mx-auto px-10">
            <div class="mx-auto text-center">
                <div>
                    ...
                    <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">
                        ...
                        laughter-filled adventure. Customise the cards based on what you need, and bring the life of the party
