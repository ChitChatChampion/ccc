        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6" id="pricing">
            ...
            <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                ...
                <div
                    ...
                    <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">Best option for personal use and
                        engaging in small conversations</p>
                    ...
                    <ul role="list" class="mb-8 space-y-4 text-left">
                        <li class="flex items-center space-x-3">
                            ...
                            <span>Unlimited Access to Free Games</span>
                        </li>
                        <li class="flex items-center space-x-3">
                            <!-- Icon -->
                ...
                <div
                    ...
                    <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">Perfect for users who needs more fun
                        and customisability.</p>
                    <div class="flex justify-center items-baseline my-8">
                ...
                <div
                    ...
                    <ul role="list" class="mb-8 space-y-4 text-left">
                        <li class="flex items-center space-x-3">
                            ...
                            <span>Shared games within a team</span>
                        </li>
                        <li class="flex items-center space-x-3">
                            <!-- Icon -->
                            <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor"
