...
<template>
  <div class="h-screen bg-gradient-to-b from-ne-light via-ne to-ne-dark z-0">
    ...
    <div class="flex gap-3 px-5 pt-10">
      ...
      <ProgressBar :value="percentage" background="ne" foreground="ne-v-light" class="my-auto" />
    </div>
    ...
    <carousel ref="myCarousel" :items-to-show="1.3" model-value="1" class="mt-16" v-model="currentSlide">
      ...
      <slide v-for="card in cards" :key="card">
        <div class="bg-light w-full text-left p-8 h-[22rem] rounded-3xl text-ne-dark text-[20px] font-medium">
          {{ card.content }}
        </div>
      </slide>
      <slide key="$end$"></slide>
